...
body.load_state_dict(torch.load('no_ROI_body.pt', map_location=device))
segment.load_state_dict(torch.load('no_ROI_segmentation.pt', map_location=device))
...
with open('MTL_test_seg_accuracy_no_ROI.csv', 'w') as file:
