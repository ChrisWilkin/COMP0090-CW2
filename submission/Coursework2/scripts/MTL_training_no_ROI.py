...
torch.save(body.state_dict(), f'no_ROI_body.pt')   #Network weights for Body 
torch.save(segment.state_dict(), f'no_ROI_segmentation.pt')    #Netowkr weights for segmentation
